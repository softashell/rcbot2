...
constexpr std::array<const char*, 23> g_szDYSWeapons =
{
	"weapon_cyber",
	"weapon_crowbar",
	"weapon_empgrenade",
...
std::vector<WeaponsData_t> DYSTOPIAWeaps =
{
	/*
		slot, id , weapon name, flags, min dist, max dist, ammo index, preference
	*/
		{1,DYS_WEAPON_CYBER,			g_szDYSWeapons[0],	WEAP_FL_PRIM_ATTACK,0,1000,-1,1,1000.0f},
		{1,DYS_WEAPON_CROWBAR,			g_szDYSWeapons[1],	WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE,0,64,-1,0,0},
		{4,DYS_WEAPON_EMPGRENADE,		g_szDYSWeapons[2],	WEAP_FL_GRENADE | WEAP_FL_EXPLOSIVE,64,180,-1,1,0},
		{2,DYS_WEAPON_MACHPISTOL,		g_szDYSWeapons[3],	WEAP_FL_PRIM_ATTACK,0,512,-1,2,800.0f},
		{3,DYS_WEAPON_SHOTGUN,			g_szDYSWeapons[4],	WEAP_FL_PRIM_ATTACK,8,512,-1,3,1000.0f},
		{3,DYS_WEAPON_LASERRIFLE,		g_szDYSWeapons[5],	WEAP_FL_PRIM_ATTACK | WEAP_FL_HOLDATTACK,0,2000,-1,3,0},
		{3,DYS_WEAPON_BOLTGUN,			g_szDYSWeapons[6],	WEAP_FL_PRIM_ATTACK | WEAP_FL_PROJECTILE,0,1400,-1,3,600.0f},
		{3,DYS_WEAPON_SMARTLOCKS,		g_szDYSWeapons[7],	WEAP_FL_PRIM_ATTACK,0,1400,-1,3,0},
		{1,DYS_WEAPON_KATANA,			g_szDYSWeapons[8],	WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE,0,64,-1,0,0},
		{4,DYS_WEAPON_GRENADE,			g_szDYSWeapons[9],	WEAP_FL_GRENADE | WEAP_FL_EXPLOSIVE,64,180,-1,1,0},
		{3,DYS_WEAPON_ASSAULT,			g_szDYSWeapons[10],	WEAP_FL_PRIM_ATTACK | WEAP_FL_SEC_ATTACK,0,2000,-1,3,1000.0f},
		{3,DYS_WEAPON_GRENLAUNCHER,		g_szDYSWeapons[11],	WEAP_FL_PROJECTILE  | WEAP_FL_EXPLOSIVE | WEAP_FL_PRIM_ATTACK | WEAP_FL_SEC_ATTACK,100,2000,-1,3,300.0f},
		{3,DYS_WEAPON_MK808,			g_szDYSWeapons[12],	WEAP_FL_PRIM_ATTACK | WEAP_FL_ZOOMABLE,0,1000,-1,3,0},
		{3,DYS_WEAPON_TESLA,			g_szDYSWeapons[13],	WEAP_FL_PRIM_ATTACK | WEAP_FL_HOLDATTACK | WEAP_FL_EXPLOSIVE_SEC,0,768,-1,3,0},
		{1,DYS_WEAPON_FIST,				g_szDYSWeapons[14],	WEAP_FL_PRIM_ATTACK | WEAP_FL_MELEE,0,64,-1,1,0},
		{2,DYS_WEAPON_HEAVYMACHPISTOL,	g_szDYSWeapons[15],	WEAP_FL_PRIM_ATTACK,0,512,-1,3,1000.0f},
		{4,DYS_WEAPON_SPIDERGRENADE,	g_szDYSWeapons[16],	WEAP_FL_GRENADE | WEAP_FL_EXPLOSIVE,0,300,-1,1,0.0f},
		{3,DYS_WEAPON_ROCKETLAUNCHER,	g_szDYSWeapons[17],	WEAP_FL_PRIM_ATTACK | WEAP_FL_EXPLOSIVE,180,2000,-1,3,1000.0f},
		{3,DYS_WEAPON_MINIGUN,			g_szDYSWeapons[18],	WEAP_FL_PRIM_ATTACK | WEAP_FL_HOLDATTACK,0,1000,-1,3,1000.0f},
		{3,DYS_WEAPON_ION,				g_szDYSWeapons[19],	WEAP_FL_PRIM_ATTACK | WEAP_FL_ZOOMABLE,0,2000,-1,3,1000.0f},
		{3,DYS_WEAPON_BASILISK,			g_szDYSWeapons[20],	WEAP_FL_PRIM_ATTACK | WEAP_FL_EXPLOSIVE_SEC,0,1500,-1,3,1000.0f},
