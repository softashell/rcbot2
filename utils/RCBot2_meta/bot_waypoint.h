...
// if you're adding a new waypoint type, don't forget to update CWaypointTypes :: setup()
	...
	static constexpr int W_FL_NOPUNK		 = 1 << 6; // Dystopia -> Punks cannot use this waypoint
	...
	static constexpr int W_FL_NOCORP		 = 1 << 7; // Dystopia -> Corps cannot use this waypoint
